...
export default function ChallengeDetails() {
  ...
  const challenge = {
    ...
    description: "Post a photo or video of your pet doing something adorable! We want to see those heartwarming moments that make you smile.",
    reward: "0.01 ETH",
    category: "Social",
    timeLeft: "2 days",
    participants: 23,
    ...
    proofType: "image",
    requirements: "Photo must be original and taken by you. Include a brief description of what makes this moment special.",
    createdAt: "2024-01-15",
    submissions: [
      { id: 1, user: "0xUser1", status: "verified", timestamp: "2h ago", preview: "Dog playing in snow" },
      { id: 2, user: "0xUser2", status: "pending", timestamp: "4h ago", preview: "Cat sleeping in sunbeam" },
      { id: 3, user: "0xUser3", status: "verified", timestamp: "1d ago", preview: "Rabbit eating carrot" },
    ]
  };
  ...
  return (
    <Layout>
      <Head>
        <title>{challenge.title} - Base Buddies</title>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 capitalize">{challenge.proofType} Upload</span>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Upload your {challenge.proofType} and provide any additional context below.
                </p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe your submission and what makes this moment special..."
                  rows={4}
                ...
                {challenge.submissions.map((sub) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center space-x-3">
                        <span className="text-sm font-medium text-secondary-700">{sub.user}</span>
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className={`text-xs font-medium ${
                          sub.status === 'verified' ? 'text-success-600' : 'text-warning-600'
                        }`}>
                          {sub.status}
                        </span>
                      </div>
                    </div>
                    <p className="text-gray-600 text-sm">{sub.preview}</p>
                  </div>
                ))}
              </div>
            </div>
